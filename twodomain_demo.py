...
if __name__ == '__main__':
    ...
    for x in paramArray:
        ...
        para['baseliner']['num_left'] = x
        path_raw_movie = join(
            path_local, para['init']['path_movie'])
        path_raw_book = join(
            path_local, para['init']['path_book'])

        print("file path", path_raw_movie, path_raw_book)
        print("file exists", exists(path_raw_movie))
        # baseliner
        ...
        para['recommender']['test_param_v'] = x
        ...
        recommender_prediction_tool = RecommenderPrediction(
            ...
            para['recommender']['calculate_xmap_sim_method_2'])
